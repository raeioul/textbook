...
this.props.deleteCourse(id);
  ...
  editCourseSubmit()
  {
    ...
    this.props.editCourseSubmit(this.props.course.id,this.nameInput.value,this.descriptionInput.value,this.textbooksInput.value);
  }
    render() {
      ...
      return (
        ...
        <tr className="bg-warning" key={this.props.index}>
          ...
          <td>
            <input defaultValue={description} ref={descriptionInput => this.descriptionInput = descriptionInput}/>
          </td>
          <td>
            <input ref={textbooksInput => this.textbooksInput = textbooksInput} defaultValue={textbooks}/>
          </td>
          <td>
